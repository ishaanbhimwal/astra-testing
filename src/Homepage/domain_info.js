...
export const domain_comp = [
  ...
  {
    comp: "Managing data connections from the processing unit to external components",
    icons: "Gear",
    domain_id: 1,
    id: 3,
  },
  {
    comp: "Designing custom printed circuit boards",
    icons: "Gear",
    domain_id: 1,
    id: 4,
  },
  ...
  {
    comp: "Assistance for traversal of any terrain",
    icons: "Gear",
    domain_id: 2,
    id: 7,
  },
  ...
  {
    comp: "Instruments for objects transportation",
    icons: "Gear",
    domain_id: 4,
    id: 13,
  },
  {
    comp: "Develop custom solutions to distribute power",
    icons: "Gear",
    domain_id: 5,
    id: 14,
  },
  {
    comp: "Coordinate with mechanical team to develop the best power delivery system for their needs",
    icons: "Gear",
    domain_id: 5,
    id: 15,
  },
